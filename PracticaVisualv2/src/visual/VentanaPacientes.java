...
public class VentanaPacientes extends javax.swing.JFrame {
    ...
    public VentanaPacientes() {
        initComponents();
        TabPaciente tabPaciente = new TabPaciente();
        tbpPaciente.add(tabPaciente);
    }
    ...
    private void initComponents() {
        ...
        panelInicio.setPreferredSize(new java.awt.Dimension(400, 300));
        tbpPaciente.addTab("tab1", panelInicio);

        getContentPane().add(tbpPaciente, java.awt.BorderLayout.CENTER);
